...
## not recommended
# python3 train.py --data data/warpedcoco.yaml --hyp data/hyp.align.origin.yaml --cfg models/align_origin.yaml --weights '' --batch-size 4 --img-size 128 --epochs 50 --adam --device 0 --mode align
...
# python3 train.py --data data/warpedcoco.yaml --hyp data/hyp.align.variant.yaml --cfg models/align_variant.yaml --weights '' --batch-size 16 --img-size 128 --epochs 50 --adam --device 0 --mode align
