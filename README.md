...
This repo allows you to finish the whole training process (including alignment and reconstruction) within 1 day.
...
Run the commands below to go through the whole process of unsupervised deep image stitching. 
